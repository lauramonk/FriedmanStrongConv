...
\begin{proof}
  ...
  and $\phi(z)$ is identically equal to $0$ on a neighbourhood of $z$.
  We then observe that $x \in \R \mapsto \phi(x) \frac{1}{2 i \pi} \frac{1}{x-z}$
  is an element of $\smooth$ and hence we can
  define $\tilde{F}_\nu(z) = \nu(\frac{1}{2 i \pi} \frac{1}{x-z} \phi)$.
