...
Then Proposition \ref{prop:norm_adjacency_sup_degree} is a trivial consequence of the
following lemma, together with the definition of bounded operator and operator norm.

\begin{lemma}
  \label{lem:bound_a_degree}
  \uses{lem:bound_a_degree}
...
\begin{lemma}
  ...
  \uses{lem:constant_is_l2,lem:constant_function_eq_zero,lem:adjacency_of_constant_regular}
