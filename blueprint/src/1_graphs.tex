...
\begin{theorem}
  ...
  Let $x, y \in V(G)$.
  Any dartwalk from $x$ to $y$ is homotopic to a unique nonbacktracking dartwalk, which we denote by $[w]$.
\end{theorem}
...
\begin{definition}
  ...
  \begin{itemize}
    ...
    $\ept_{\hat{G}}(d) = [w \cdot d]$ and $\symm_{\hat{G}}(w,d) = ([w \cdot d],\symm_G(d))$;
...
\begin{theorem}
  ...
  The universal cover $\hat{G}$ of $(G,r)$ is a tree.
\end{theorem}
